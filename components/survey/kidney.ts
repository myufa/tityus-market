...
const kidneySurveyQuestions: SurveyQuestionPartial[] = [
    { text: 'Are you in good health?', value: 10 },
    ...
    { text: 'Have you had more than 2 kidney stones in your lifetime?', value: INELIGABLE  },
    { text: 'Have you ever had cancer?', value: INELIGABLE },
    { text: 'Have you ever had recurrent bladder or kidney infections?', value: INELIGABLE  },
    { text: 'Have you ever had Polycystic Kidney Disease or a genetic renal disease?', value: INELIGABLE  },
    { text: 'Have you ever been told you had protein or blood in your urine or had other kidney problems?', value: INELIGABLE },
    ...
    { text: 'In the past 12 months, have you had sex, even once, with anyone who has used a needle to take drugs, steroids, or anything else not prescribed by a doctor in the past 5 years?', value: -3_000 },
    ...
    { type: SurveyQuestionType.HEADING, text: 'Have you ever been diagnosed by a doctor, therapist or counselor with one of the following conditions?', value: -5_000 },
    { type: SurveyQuestionType.SUBHEADING, text: 'Please check all that apply.', value: -5_000 },
...
//  = unchanged"
    ...
    { type: SurveyQuestionType.HEADING, text: 'Have you used any of the following drugs in the last year?\nPlease check all that apply.', value: 10 },
...
{ type: SurveyQuestionType.HEADING, text: 'Are you taking, or have you taken in the past, any of the following antidepressant medications?', value: -5_000 },
...
// 6-10= -$3000
// 11-15=-$5000
// 16-17=-$8000"	unchanged
{ type: SurveyQuestionType.HEADING, text: 'Are you taking, or have you taken in the past, any of the following mood stabilizing medications?', value: 0 },
...
// "	"all options
// =-$2000"	unchanged
{ type: SurveyQuestionType.HEADING, text: 'Are you taking, or have you taken in the past, any of the following antipsychotic medications?', value: 0 },
...
// 4-6= -$3000
// 711=-$5000
// 12-14=-$8000"	unchanged
{ type: SurveyQuestionType.HEADING, text: 'Are you currently taking any of the following medications at least once per day?', value: 0 },
...
const kidneySurvey = new Map<number, SurveyQuestion>(
    kidneySurveyQuestions.map((q, idx) =>
